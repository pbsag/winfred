...
RUN PGM=HIGHWAY PRNFILE="{SCENARIO_DIR}\Output\Logs\HighwayAssign_AM.PRN" MSG='Load Final Trips onto Network AM'
FILEI TURNPENI = "{SCENARIO_DIR}\Input\TurnPenalties.pen"
FILEO MATO[1] = "{SCENARIO_DIR}\Output\SL_Loaded_AM.MAT",
MO=5-8, NAME=SL_DA,SL_SR,SL_IEEI, SL_CV
FILEI NETI = "{SCENARIO_DIR}\Output\PRELOADED_AM.NET"
FILEI MATI[1] = "{SCENARIO_DIR}\Output\ODAUTO_AM.MAT"
FILEO PATHO[1] = "{SCENARIO_DIR}\Output\LOADED_AM.PTH"
FILEO NETO = "{SCENARIO_DIR}\Output\LOADED_AM.NET",
      DEC = 0
...
/*
  ...
  */
  ...
  PATHLOAD PATH=LW.COSTd , MW[5] = MI.1.7*PCE, VOL[5] = MW[5],  PENI = 1,
      MW[9] = MI.1.7*PCE, SELECTLINK=({SelectLink}), VOL[9]=MW[9]  ,EXCLUDEGROUP = 1
